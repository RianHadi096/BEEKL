                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                           <div class="d-flex align-items-center">
                               <?php
                                   $searchUser = $userModel->find($user['id']);
                               ?>
                               <div class="avatar-frame <?= isset($searchUser['avatar_frame']) ? 'frame-'.$searchUser['avatar_frame'] : '' ?> me-2">
                                   <img src="<?= $searchUser['avatar'] ?>" class="rounded-circle" width="40" height="40" alt="<?= esc($searchUser['name']) ?>'s avatar"/>
                               </div>
                               <div>
